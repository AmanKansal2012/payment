...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                payUsingUpi(amount, upiId, name, note,sendername);
            }
        });
    }
    ...
    void payUsingUpi(String amount, String upiId, String name, String note,String sendername) {


        HashMap<String,String> appointment= new HashMap<>();
        appointment.put("Name",sendername)
